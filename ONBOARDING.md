...
- `Ctrl+O` 展开完整启动信息
- `pi list` 的 **User packages** 里应有三项：`pi-workflow@v1.6.5`、`pi-context-view`、`pi-rtk-optimizer`

**没生效就按顺序查**：第 2 步的凭据配了吗 → `pi list` 里有 `pi-workflow@v1.6.5` 吗
...
pi install git:github.com/kurumi1ksllq/pi-workflow@v1.6.5   # 2. 换版本
...
```bash
pi install git:github.com/kurumi1ksllq/pi-workflow@v1.6.5   # 1. 换到钉版本的清单
