...
```
git:github.com/<org>/pi-workflow@v1.13.2
```
...
```bash
bash scripts/simulate-member.sh v1.13.2
```
...
PI_CODING_AGENT_DIR="$SB" pi install git:github.com/kurumi1ksllq/pi-workflow@v1.13.2
